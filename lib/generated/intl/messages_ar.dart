...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(data) => "قلب الكاميرا  ${data}";

  static String m1(data) => "  المسابقات اليومية في ${data} ";

  static String m2(data) => "فلاش  ${data}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "enterPassword": MessageLookupByLibrary.simpleMessage(
            "رجاء قم بإدخال كلمة مرور صالحة"),
        "enterUserName":
        ...
        "letsStartToScanAQrForYourBill":
            MessageLookupByLibrary.simpleMessage("فلنبدأ في مسح Qr لفاتورتك"),
