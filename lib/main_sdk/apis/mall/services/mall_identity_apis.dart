...
class MallIdentityApi extends ApiModelIdentity {
  Future<ResponseState<ListOfMallModel>> getMalls(
      {required MallParamsModel mallParamsModel}) async {
  ...
  Future<ResponseState<DataModel>> getData(
      {required DataParamsModel dataParamsModel}) async {
    return apiMethod('data.php',
        data: dataParamsModel.toMap(),
        httpEnum: HttpEnum.post,
        parseJson: (json) => DataModel.fromJson(json));
  }
}
